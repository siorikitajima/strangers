...
function IFrameFF(count) {
    const theHeight = window.innerHeight - 40;
    return <Iframe key={count} url="https://strangersinmyhead.info/perspective-sketches/FF/" width="100%" height = {theHeight} display="initial" position="relative" frameBorder="none" styles={{margin: "0", border: "none"}}/>
};
