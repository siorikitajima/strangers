...
function DataAD() {
    return(
        <div className="dataVizContainer">
            ...
            <p><span>1/200</span> people in Singapore has experienced <br/><b>Alcohol Dependence</b> in their life.</p>
            </div>
            ...
            <h2>What is Alcohol Dependence</h2>
            ...
            <a href="#/help/alcohol-dependence">
