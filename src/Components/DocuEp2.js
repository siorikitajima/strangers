...
function DocuEp2() {
    ...
    return(
        <div className="epContainer">
            ...
            <Iframe url="https://player.vimeo.com/video/487974256"
                width="640"
                height = "360"
                display="initial"
                position="relative"
            ...
            <a href="https://www.channelnewsasia.com/news/video-on-demand/strangers-in-my-head/moving-to-my-own-beat-13768642/" target="_blank" rel="noopener noreferrer">
