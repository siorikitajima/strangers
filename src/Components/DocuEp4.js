...
function DocuEp4() {
    ...
    return(
        <div className="epContainer">
            ...
            Jess is a passionate pursuer of the arts. She is a creative director and founded her very own visual arts studio. She is a freelance hand poke tattoo artist and a co-partner of a vintage wear online retail site. Jess is also managing co-morbid mental health issues and she has chosen to confront the stigma, rather than retreat from judgements.</p>
            <p>Jess had been through some trying times in her childhood years which triggered co-morbid mental health issues such as Anxiety, Post-Traumatic Stress Disorder, Dissociative Identity Disorder to name a few. There were many times when she was destructive, felt lost and wanted to give up.</p>
