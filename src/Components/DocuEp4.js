...
function DocuEp4() {
    ...
    return(
        <div className="epContainer">
            ...
            <Iframe url="https://player.vimeo.com/video/491877772"
                width="640"
                height = "360"
                display="initial"
                position="relative"
            ...
            <a href="https://www.channelnewsasia.com/news/video-on-demand/strangers-in-my-head/the-mind-s-chaos-13842854" target="_blank" rel="noopener noreferrer">
