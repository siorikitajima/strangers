...
function DocuEp1() {
    ...
    return(
        <div className="epContainer">
            ...
            <Iframe url="https://player.vimeo.com/video/487974312"
                width="640"
                height = "360"
                display="initial"
                position="relative"
            ...
            <a href="https://www.channelnewsasia.com/news/video-on-demand/strangers-in-my-head/a-face-in-the-crowd-13703458" target="_blank" rel="noopener noreferrer">
