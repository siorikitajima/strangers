...
function ExpStories() {
    ...
    "Dying to be Alive" by <b>Sha-En Yeo</b>, Happiness Scientist
            ...
            <p>In 2015, I received a text from an ex-colleague: “Recalling all CARE (Caring Action in Response to Emergencies) trained officers. Please standby to offer support.” At that moment, I was puzzled – what support did they need from us?</p>
            ...
            <p>I was deployed to the wake of a 12 year old girl. She was months away from taking her Primary School Leaving Examination (PSLE), an examination she must have been preparing very hard for. At the wake, her mother played a tape of her in her ballet attire, a confident smile spread over her face as she did each pirouette. I imagined the years of time, energy and love that had gone into this little girl, and now there she was, resting in a coffin, way too early. It was heart-wrenching watching as her family collapsed into sobs each time someone said “We’re sorry for your loss”.</p>
            <p>My job was to check-in with the girls’ friends (fellow students) to see how they were coping; also, with the survivors who had returned from Mount Kinabalu, scathed from the earthquake and heartbroken from the loss of their friends. Many of them were still in shock, unsure of how to respond. I lay out pens and colourful paper, and ask the students to write a goodbye note, and pin it on a tree. Many share stories of their friend: her good qualities and fond memories they remember. I’m holding back my tears.</p>
            <p>At around 4pm, a man decked in a yellow robe walks in. He is carrying a bell and walks hurriedly over to the family. They look relieved to see him, and quickly gather their whole family to stand up and surround the coffin. Two candles are lit. He rings the bell several times, begins chanting in words I don’t recognize, and then he walks around and around the coffin.</p>
            <p>Watching him performing the ritual makes me want to turn and run. It doesn’t feel right! Why is this happening to someone so young and innocent? What if she doesn’t want the Priest to be here? Did she even have a choice of what last rites she wanted? What would she have wanted to do with her life?</p>
            ...
            <p>That night, after the funeral, I lay in bed and cried. I cried for the mother who had lost a daughter (for I too, have 2 daughters); I cried for the loss of the potentially bright future this girl had – the graduations, the birthdays, the challenges & adventures. But mostly, I cried because of the reminder this experience had given me: You are ALIVE!</p>
            <p>As the months passed following her funeral, I found myself going back to this moment over and over again. Now you may think this is a surefire way of making myself sad & depressed, but this practice of contemplating death actually brought greater clarity into my life.</p>
            ...
            <p>In fact, that same year, I read with enthusiasm Eric Weiner’s article: Bhutan’s dark secret to happiness. In Bhutan, one of the only countries in the world that measures Gross National Happiness (GNH), they do not fear death. On his travels to the magical country, Eric Weiner got talking with Ura, (director of the Centre for Bhutan Studies) who shared that thinking about death was part and parcel of normal living. In fact, the knowledge that one day they would cease to exist was not a morbid thought, but one that could perhaps be a secret to their happiness. In research conducted by Roy Baumeister & Nathan DeWall (2007), they found that subjects who had been asked to think about death completed word stems (e.g. “jo__”) more positively. Their conclusion? The more the “people contemplate [death], apparently the automatic system begins to search for happy thoughts.”</p>
            <h3>Being truly alive</h3>
            <p>Indeed, this has rung true for me. Many nights, as I sit in contemplation reviewing those moments as I watched the priest go around the around the coffin, I ask myself: What does it mean to be truly alive? It is a powerful question that brings into focus what is really important. Every day is not to be taken for granted, as it has been given to me. Over the years since then, I’ve come to define being alive as:</p>
            <ol>
              <li>Saying ‘yes’ to life i.e. do things that inspire, bring you joy</li>
              <li>Letting go of all that burdens me e.g. anger, baggage</li>
              <li>Leaving a legacy that will make the world a better place</li>
              <li>Spending time with the people that matter</li>
            </ol>
            <p>I have internalised these 4 principles well over the last 4 years. Perhaps in some way, it is a way of saying to the girl: your death meant something. So while it is a tragedy that she perished, ironically, pondering on death has allowed me to find new conviction to truly live. And it is from living these principles, that I truly feel happy within.</p>
            <p>How about you? If you knew death awaits, what would you do? I’d love to hear your thoughts & comments.</p>
