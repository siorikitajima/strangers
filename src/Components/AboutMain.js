    ...
    return(
        <div className="aboutMain">
            <div className="heroBanner">
                ...
                <h1>&#47;&#47; Hello Friend &#47;&#47;</h1>
                <p>For a long time, I had been thinking of realising a documentary series on mental health – a series that tells the nuanced stories of the many struggles and complexities related to mental health conditions.</p>
                ...
                <p>Created alongside the documentary series, this resource site is our attempt to reach out. The journey towards better mental health need not be lonesome. To quote <i>Winnie the Pooh - You can't stay in your corner of the Forest waiting for others to come to you. You have to go to them sometimes.</i> Strangers In My Head is us walking with and walking towards friends, families, caregivers and strangers who are coping and living with mental health conditions. While we may not fully understand or grasp the arduous path each person struggling with a mental health condition is walking, let us not judge. Let us be willing to hold the other person’s hand.</p>
