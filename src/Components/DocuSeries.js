...
function DocuSeries() {
    return(
        <div className="epContainer">
            <h2>One in 4</h2>
            <p>People in the world suffer from mental health issues at some point in their life. This is an elusive and lonely battle that few talk about but many form opinions of. So, what constitutes our mental health? Why does society shun conversations about and around the states of mental health?</p>
            <p>To find answers, we step into the world of four individuals dealing with different mental health issues, and observe. Strangers In My Head is a 4-part documentary series that journals the perspective of each individual as they reveal the layers of their relationship with mental health issues and what being “normal” means to them.</p>
