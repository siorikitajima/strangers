...
function AboutCredit() {
    return(
        <div className="creditContainer">
            ...
            <a href="https://github.com/siorikitajima/Test-Site/tree/master/strangersWalkers" rel="noopener noreferrer" target="_blank">Fork 'Scene' on github</a><br/>
            <img src={P5Icon}alt="P5js icon" className="sm-icons"/>
            <a href="https://editor.p5js.org/siorikitajima/sketches/KZAKAzTSF" rel="noopener noreferrer" target="_blank">Fork 'Number Zero' on p5</a></p>
